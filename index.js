...
*/
createMenuItem("Chicken N Waffles",8,"Breakfast")
createMenuItem("Fried Gator",6,"Lunch")
createMenuItem("Sweet Potato Pie",12,"Dessert")
...
export const burger = {
  ...
  discount: function(customer){
      if(customer === "teacher" || customer === "student"){
        const discountedPrice = this.price * .75;
        console.log(discountedPrice);
        return discountedPrice
      } else {
        const discountedPrice = this.price * .9;
        console.log(discountedPrice);
        return discountedPrice
      }
    }
...
*/
reviews.push({name: "Adam", rating: 5, feedback: "The food was so good, it brought me back from the grave just to get another bite!"})
